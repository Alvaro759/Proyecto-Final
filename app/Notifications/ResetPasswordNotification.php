...
class ResetPasswordNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject('Notificacion de reseteo de contraseña')
            ->greeting('Hola!')
            ->line('Estás recibiendo este email porque se solicitó un reestablecimiento de contraseña para la cuenta.')
            ->action(('Reestablecer contraseña'), $url)
            ->line(Lang::get('Este link caducará en :count minutes.', ['count' => config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')]))
