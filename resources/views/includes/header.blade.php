<header class="mt-3">
    <div class="d-flex justify-content-evenly">
                ...
                <div class="nav-custom-unique" id="nav-custom">
                    ...
                    <ul>
                        @foreach ($categories as $category)
                            <li><a class="AHover" href="{{ route('categoria', ['nombreCategoria' => $category->nombre])}}">{{ $category->nombre }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            @else
                <a class="d-flex AHover" href="{{ route('login')}}">
        ...
        <div class="d-flex align-items-center">
            <a class="d-flex AHover" href="{{ route('carrito')}}">
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px"
                    fill="#000000">
                    <path
        ...
        <div class="d-flex align-items-center">
            <a class="d-flex AHover" href="{{ route('panel.index')}}">
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px"
                    fill="#000000">
                    <path
